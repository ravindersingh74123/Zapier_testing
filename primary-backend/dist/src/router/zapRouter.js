...
router.post("/", middleware_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const zapId = yield index_1.default.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
        const zap = yield index_1.default.zap.create({
            data: {
                userId: parseInt(id),
                triggerId: "",
                actions: {
...
router.get("/", middleware_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // @ts-ignore
    const id = req.id;
    const zaps = yield index_1.default.zap.findMany({
        where: {
            userId: id
        },
        include: {
...
router.get("/:zapId", middleware_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const id = req.id;
    const zapId = req.params.zapId;
    const zap = yield index_1.default.zap.findFirst({
        where: {
            id: zapId,
            userId: id
        },
